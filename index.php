    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <p class="intro-subtitle"><span class="text-slider-items">Intern at HNGi7, Web Developer, Beginner Mobile Dev,Student Of Mathematics and Computer Science</span><strong class="text-slider"></strong></p>
...
Am also strong conceptive thinker who has strong interest in all things relating to the internet. Jude is a web developer since 2014, he has experience in designing, developing and deployment of interactive websites. Able to complete projects efficiently and satisfy customers with responsive and attractive user-friendly websites.
          ...
          <div class="col-sm-4">
            <div class="service-box">
              ...
              <div class="service-content">
                <h2 class="s-title">Web SEO and Analytics</h2>
              </div>
            </div>
          </div>
          <div class="col-sm-4">
    ...
    <!-- ======= Contact Section ======= -->
    <section class="paralax-mf footer-paralax bg-image route" style="background-image: url(assets/img/overlay-bg.jpg)">
      <div class="overlay-mf"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
